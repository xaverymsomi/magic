<div id="page-content">
    ...
    <div id="display_content">
        <form name="activation" ng-submit="saveProfileOperation('<?php echo $this->controller ?>', '<?php echo $this->action ?>')" novalidate>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <span style="padding-left: 90px;">In order to activate <?php echo htmlspecialchars($this->name, ENT_NOQUOTES, 'UTF-8')?>, you must click the</span>
                            ...
                            <strong>I have read and agreed to the <span class="text-success"><a target="_blank" href="/assets/public/Privacy%20Policy%20for%20Merchant.pdf"><?php echo APP_NAME ?> Activation Policy </a></span></strong>
                        </div>
                    </div>
                    <div class="form-group">
...
<!--                            <textarea class="form-control" cols="50" id="tar_reason" placeholder="Write reason" name="tar_reason" ng-class="form.tar_reason.$invalid && !form.tar_reason.$pristine" ng-model="form.tar_reason" required></textarea>-->
                            <textarea class="form-control" cols="50" id="tar_reason" placeholder="Write reason" name="tar_reason" ng-model="form.tar_reason"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" ng-disabled="activation.$invalid || ProcessingData === true" class="btn btn-info" name="submit">Submit</button>
