<div id="page-content">
    ...
    <div id="display_content">
        <form name="close" ng-submit="saveProfileOperation('Offence', 'process_close')" novalidate>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <span style="padding-left: 90px;">In order to close <?php echo htmlspecialchars($this->name, ENT_NOQUOTES, 'UTF-8')?>, you must click the</span>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" ng-disabled="close.$invalid || ProcessingData === true" class="btn btn-info" name="submit">Submit</button>
