<div id="page-content">
    ...
    <div id="display_content">
        <form name="suspend" ng-submit="saveProfileOperation('<?php echo $this->controller ?>', '<?php echo $this->action ?>')" novalidate>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <span style="padding-left: 90px;">In order to suspend <?php echo htmlspecialchars($this->name, ENT_NOQUOTES, 'UTF-8')?>, you must click the</span>
                            <br><span style="padding-left: 90px;">“I have read and agreed to <?php echo APP_NAME ?> suspension policy” and then click the “Submit” button.</span><br><br>
                            <span style="padding-left: 90px;"><input type="checkbox" id="checkme" name="checkme"  ng-model="checkme" required> </span>
                            <strong>I have read and agreed to the <a target="_blank" href="/assets/public/Privacy%20Policy%20for%20Merchant.pdf"><span class="text-danger"><?php echo APP_NAME ?> Suspension Policy</span> </a></strong>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" ng-disabled="suspend.$invalid || ProcessingData === true" class="btn btn-info" name="submit">Submit</button>
