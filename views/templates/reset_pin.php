    ...
    <div id="display_content">
        <form name="reset_pin" ng-submit="saveProfileOperation('<?php echo $this->controller ?>', '<?php echo $this->action ?>')" novalidate>
            <div class="modal-header" style="background:#843534; color: white;">
                ...
                <h4 class="modal-title ocean"><i class="fa fa-undo fa-fw fa-2x"></i><?php echo htmlspecialchars($this->title, ENT_NOQUOTES, 'UTF-8')?></h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <h2 class="text-warning"><i class="fa fa-undo fa-fw fa-2x"></i><?php echo $this->subtitle ?></h2>
                            <span style="padding-left: 90px;">In order to reset pin <?php echo htmlspecialchars($this->name, ENT_NOQUOTES, 'UTF-8')?>, you must click the</span>
                            ...
                            <strong>I have read and agreed to the <span class="text-warning"><?php echo APP_NAME ?> Reset Pin Policy</span></strong>
                        </div>
                    </div>
