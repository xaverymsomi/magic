...
class ControlNumberGenerator
{
    ...
    {
        $check = (new Model())->getRecordByFieldName('mx_invoice', 'txt_control_number', $control_number, true);
        if (empty($check)) {
            return true;
        }
        return false;
    ...
    {
        $check = (new Model())->getRecordByFieldName('mx_invoice', 'txt_invoice_number', $invoice_number, true);
        if (empty($check)) {
            return true;
        }
        return false;
