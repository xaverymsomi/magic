<div id="page-content">
    ...
    <div id="display_content">
        <form name="emailcontent" ng-submit="saveForm()" novalidate>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" ng-disabled="emailcontent.$invalid" class="btn btn-info" name="submit"> Submit </button>
                <button ng-disabled="ProcessingData === true" ng-click="close()" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            </div>
        </form>
    </div>
</div>