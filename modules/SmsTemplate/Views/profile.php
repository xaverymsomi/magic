            ...
            <div class="modal-body">
                <div style="margin-bottom: 15px;">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#SmsTemplate" ng-click="getProfileRecords('SmsTemplate', '<?php echo $this->data['row_id'] ?>')">SMS Template</a>
                        </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="SmsTemplate">
                        <div class="row profile_section">
                            <div class="col col-md-6">
                                <table class="table table-condensed table-striped table-bordered table-responsive">
                                    <thead>
                                        <tr class="bottom-border-color-green primary">
                                            <th colspan="2">SMS Template</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr ng-repeat="(key, value) in initial_tab_data" ng-if="hidden_columns.indexOf(key) < 0 && key !== 'row_id'">
                                            <th class="blue">{{key}}</th>
                                            <td class="text-right" ng-if="key !== 'Language'">{{value}}</td>
                                            <td class="text-right" ng-if="key === 'Language'"><img height="30" src="/assets/images/{{value == 1 ? 'tz_flag.png' : 'en_flag.png'}}"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
