<div id="page-content">
    ...
    if ($this->resultData['recordsFiltered'] > 0) {
        ...
        $this->postData['location'] . '\'" mx-title="\'SMS Contents List\'" mx-current-link="\'' .
        ...
        $this->postData['location'] . '\'" mx-page-title="\'SMS Contents List\'" mx-page-current-link="\'' .
        ...
        echo '<div>No SMS Content Available</div>';
    }
    echo '</div>';
    ?>
</div>