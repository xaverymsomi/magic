<div id="page-content">
	...
	<div id="display_content">
		<form name="user" ng-submit="saveProfileOperation('User', 'post_change_user_group')" novalidate>
