<div id="page-content">
    ...
    <div id="display_content">
        <form name="user" ng-submit="saveProfileOperation('User', 'post_edit')" novalidate>
            ...
            <div class="modal-body">
                ...
                <div class="form-horizontal">
                    <?php
                    include 'forms/edit_user.html';
                    ?>
                </div>
            </div>
            <div class="modal-footer">
                <span ng-if="ProcessingData === true"><i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i> Processing your request, please wait... &nbsp; &nbsp;</span>
                <button type="submit" ng-disabled="user.$invalid || ProcessingData === true" class="btn btn-info" name="submit"> Submit </button>
