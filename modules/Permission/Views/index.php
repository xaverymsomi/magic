<div id="page-content">
    <!-- Controller -->
    <div id="data_content"
         data-permission-detail="<?php use Libs\Perm_Auth;
    ...
    <div ng-controller="permissionCtrl" ng-init="getData();">
        <div class='container-fluid'>
            <ul class="nav nav-tabs">
                ...
                if ($perm->verifyPermission(strtolower('manage_user_permissions'))) {
                    ?>
                    <li ng-class="{active: isActiveTab(2)}"><a href="#" ng-click="setActiveTab(2);">User Permissions</a></li>
                    <?php
                }
                if ($perm->verifyPermission(strtolower('manage_permissions'))) {
                    ?>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="new_group" ng-submit="saveForm('Permission', 'post_saveGroup')">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="new_group_permission">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="group_id" name="group_id" ng-options="value.id as value.name for (key, value) in account_detail.groups" 
                                                ng-model="new_group_permission.group_id" ng-change="getPermissions('getGroupPermissions', new_group_permission.group_id);"
                                                required>
                            ...
                            <div class="table-responsive scrolled-div" ng-show="group_permission_flag" style="max-height: 65vh">
                                ...
                                <div class="col-md-6"><button type="submit" ng-disabled="!gp_check" class="btn btn-primary" ng-click="saveTableData('group_permission_table', 'post_GroupPermission', new_group_permission.group_id);
        ...
        <div ng-show="isActiveTab(2);">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default" >
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="user_id" name="user_id"
                                                ng-model="new_user_group.user_id" required ng-change="getPermissions('getUserGroups', new_user_group.user_id);">
                                            <option value=""> Select  User</option>
                                            <option ng-repeat="(key,value) in account_detail.users" value="{{value.id + ',' + value.domain}}"> {{value.name}}</option>
                                            <!--user options comes from database-->
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive" ng-show="user_group_flag">
                                ...
                                <div class="col-md-6"><button type="submit" ng-disabled="!us_check" class="btn btn-success" ng-click="saveTableData('user_group_table', 'post_UserGroup', new_user_group.user_id, false);
                ...
                <?php if ($perm->verifyPermission(strtolower('assign_user_permission'))) {
                    ?>
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" id="new_user_permission">
                                    <div class="form-group">
                                        <label for="user_id" class="col-md-3 control-label">User Name</label>
                                        <div class="col-md-9">
                                            <!--ng-options="value.id as value.name for (key, value) in account_detail.users"-->
                                            <select class="form-control" id="group_id" name="user_id" 
                                                    ng-model="new_user_permission.user_id" ng-change="getPermissions('getUserPermissions', new_user_permission.user_id);" required>
                                                <option value=""> Select  User</option>
                                                <option ng-repeat="data in account_detail.users" value="{{data.id + ',' + data.domain}}"> {{data.name}}</option>
                                                <!--user options comes from database-->
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive scrolled-div" ng-show="user_permission_flag" style="max-height: 65vh">
                                    ...
                                    <div class="col-md-6"><button type="submit" ng-disabled="!up_check" class="btn btn-info" ng-click="saveTableData('user_permission_table', 'post_UserPermission', new_user_permission.user_id);
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="new_section" name="new_section" ng-submit="saveForm('Permission', 'post_saveSection')" novalidate>
                                <div class="form-group">
                                    <label for="name" class="col-md-3 control-label">Section</label>
                                    <div class="col-md-9">
                                        <input type="name" class="form-control" id="name" placeholder="Write section name" ng-class="new_section.name.$invalid && !new_section.name.$pristine" ng-model="form.txt_name" required>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Select User Form -->
                            <form class="form-horizontal" id="new_permission" ng-submit="saveForm('Permission', 'post_savePermission')">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="section_id" ng-options="value.id as value.name for (key, value) in account_detail.sections"
                                                name="section_id" ng-model="form.section_id" required>
